...
public class SJW extends Enemy {
    ...
    public SJW(double X, double Y) {
        ...
        switch (typ) {
            ...
            case 0:
                sprite = new Image("/gfx/sjw0_alive.png");
                break;
            case 1:
                sprite = new Image("/gfx/sjw1_alive.png");
                break;
            default:
                break;
    ...
    public void kill() {
        ...
        switch (typ) {
            ...
            case 0:
                death = new AudioClip(this.getClass().getResource("/sfx/SJW1.mp3").toString());
                sprite = new Image("/gfx/sjw0_death.png");
                break;

            case 1:
                death = new AudioClip(this.getClass().getResource("/sfx/SJW2.mp3").toString());
